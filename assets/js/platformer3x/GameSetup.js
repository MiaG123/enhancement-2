      ...
      let hillsGameObjects = allHillsGameObjects.filter(obj => !obj.difficulties || obj.difficulties.includes(difficulty));
       ...
       new GameLevel( {tag: "hills", callback: this.playerOffScreenCallBack, objects: hillsGameObjects } );
               ...
               const quidditchGameObjects = [
                ...
                //wall/tower
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.lionpattern, xPercentage: 0.456, yPercentage: 0.62 },
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.yellowpattern, xPercentage: 0.456, yPercentage: 0.683 },
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.yellowredpattern, xPercentage: 0.456, yPercentage: 0.746 },
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.yellowpattern, xPercentage: 0.456, yPercentage: 0.809 },
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.lionpattern, xPercentage: 0.456, yPercentage: 0.872 },
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.yellowpattern, xPercentage: 0.456, yPercentage: 0.935 },
                { name: 'blocks', id: 'jumpPlatform', class: SpawnPlatform, data: this.assets.platforms.yellowredpattern, xPercentage: 0.456, yPercentage: 0.998 },
